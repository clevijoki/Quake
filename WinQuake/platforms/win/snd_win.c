...
typedef HRESULT(WINAPI *DirectSoundCreateFunc)(GUID FAR *lpGUID, LPDIRECTSOUND FAR *lplpDS, IUnknown FAR *pUnkOuter);
...
sndinitstat SNDDMA_InitDirect (void)
{
	...
	if (!hInstDS)
	{
		...
		pDirectSoundCreate = (DirectSoundCreateFunc)GetProcAddress(hInstDS,"DirectSoundCreate");
