...
typedef HRESULT(WINAPI *DirectInputCreateFunc)(HINSTANCE hinst, DWORD dwVersion,
	LPDIRECTINPUT * lplpDirectInput, LPUNKNOWN punkOuter);

DirectInputCreateFunc pDirectInputCreate;
...
qboolean IN_InitDInput (void)
{
	...
	{
		pDirectInputCreate = (DirectInputCreateFunc)GetProcAddress(hInstDI,"DirectInputCreateA");
